...
public class BookingHomePage extends BasePage {
    ...
    public void checkInCheckOut (String checkInMonth, String checkInYear,String checkInDay, String checkOutMonth, String checkOutYear, String checkOutDay){

        //clickElement(checkInCheckOut, "Clicked: Check In / Check Out");
        clickDate(checkInMonth, checkInYear,checkInDay);
        clickDate(checkOutMonth, checkOutYear, checkOutDay);
     ...
     */
    public void addQuests (int adultNum, int childrenNum, String[] childrenAge, int roomsNum) throws InterruptedException {
    ...
    public void addChildrenNum(int num, String [] year) throws InterruptedException {
        for(int i = 1; i<=num;i++) {
            clickElement(childrenAdd,"Add Children");
            selectByText(chrildrenAge.get(i-1), year[i-1], " from child age select");
            Thread.sleep(2000);
            clickElement(quests);
            Thread.sleep(1000);
